...
if [ "$SRC" == "en" -a "$TGT" == "pt" ]; then
  PARA_SRC_VALID=$PARA_PATH/dev/newstest2013-ref.en
  PARA_TGT_VALID=$PARA_PATH/dev/newstest2013-ref.pt
  PARA_SRC_TEST=$PARA_PATH/dev/newstest2014-pten-ref.en
  PARA_TGT_TEST=$PARA_PATH/dev/newstest2014-pten-ref.pt
fi
